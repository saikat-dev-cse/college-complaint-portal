...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_settings']) && $isSuperAdmin) {
    ...
    $message = "<script>document.addEventListener('DOMContentLoaded', function() { Swal.fire({icon: 'success', title: 'Settings Updated!', text: 'The global website branding has been changed.'}).then(() => { window.location.href = 'admin.php'; }); });</script>";
}
...
<head>
    ...
    <style>
        .analytics-panel { display: flex; gap: 20px; align-items: center; background: var(--glass-bg); padding: 20px; border-radius: 20px; box-shadow: var(--shadow); margin-bottom: 20px;}
...
<body class="admin-layout">
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <?php endif; ?>
            <li><a href="logout.php" style="color:white;" class="logout mobile-logout">🚪 Logout</a></li>
        </ul>
    </aside>
    ...
    <main class="main-content fade-in">
        <header class="admin-header">
            ...
            <div style="display: flex; align-items: center; gap: 15px;">
                <button class="btn-outline btn-small" onclick="exportTableToCSV('complaints_data.csv')" style="border-color: #16a34a; color: #16a34a;">📊 Export Excel</button>
                ...
                <div class="admin-profile" style="background: var(--glass-bg); padding: 8px 16px; border-radius: 20px; font-weight: bold; border: 1px solid var(--border-color);">
        ...
        <div id="section-complaints">
            <div class="analytics-panel">
                <div class="stats-grid">
                    ...
                    <div class="stat-card" style="padding:15px; color:#d97706;">Pending: <strong><?php echo $pending; ?></strong></div>
                    <div class="stat-card" style="padding:15px; color:#16a34a;">Resolved: <strong><?php echo $resolved; ?></strong></div>
                </div>
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    $btn = ($row['status'] == 'Pending') ? "<a href='admin.php?resolve_id={$row['id']}' class='btn-primary btn-small'>Resolve</a>" : "<span style='color:#166534; font-weight:bold;'>✔ Done</span>";
        ...
        <div id="section-settings" style="display: none;">
            <div class="glass-card fade-in" style="max-width: 600px; margin: 0 auto; border-top: 5px solid #eab308;">
                <h3 style="color: #ca8a04;">⚙️ Global Site Settings</h3>
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn-primary w-100 mt-20" style="background: #ca8a04;">Update Platform</button>
                </form>
            </div>
        </div>
        <?php endif; ?>
